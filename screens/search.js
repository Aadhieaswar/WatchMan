...
export default class Search extends Component {
  ...
  returnResults = async (txt) => {
    search = txt
    const results = await getResult(txt)
    await this.addToArray(results)
  }
        ...
        <TouchableWithoutFeedback Style={styles.container} onPress={Keyboard.dismiss}>
          <View style={styles.container}>
            <Text style={styles.sText}>
              ...
              <TextInput placeholder='Search...' style={styles.input} onChangeText={(text) => this.returnResults(text)}/>
